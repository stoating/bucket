(ns bucket.wraps.compose
  (:require [bin.defaults :as default]
            [bucket.wraps.wrapper.redirect-stdout :refer [redirect-stdout]]
            [bucket.wraps.wrapper.catch-error :refer [catch-error]]
            [bucket.wraps.wrapper.log-function :refer [log-function]]
            [bucket.wraps.wrapper.log-args :refer [log-args]]
