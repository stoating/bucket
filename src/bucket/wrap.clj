...
(defn wrap
  "Main decorator that combines error handling and function logging.
   ...
   - opts: optional map with keys:
     ...
     - :args-check-pass  when logging args, redact password-like values (default true)
  ...
  ([f]
   (wrap f {}))
  ([f {:keys [catch-error? log-args? args-check-pass log-function? spacing
              redirect-stdout? stack-exclude redirect-mode]
       :or {args-check-pass true
            catch-error? true
            log-args? true
            log-function? true
   ...
   (cond-> f
     ...
     redirect-stdout? (redirect-stdout
                       ...
                       :mode redirect-mode)
     log-args? (log-args :check-pass args-check-pass)
